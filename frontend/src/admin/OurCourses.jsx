...
function OurCourses() {
  ...
  const token = storedAdmin ? JSON.parse(storedAdmin) : null; // token is directly stored
 ...
 // delete courses
  ...
  return (
      ...
      <Link
        className="rounded-lg mb-5 text-2xl p-2 text-amber-600 hover:text-white hover:bg-orange-700 duration-300"
        to={"/admin/dashboard"}
      >
        Go to dashboard
      </Link>
